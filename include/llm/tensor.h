...
class Tensor {
 public:
  ...
  bool is_contiguous() const; Tensor reshape(const std::vector<int64_t>& shape) const; Tensor prefix_first_dim(size_t size) const; Tensor slice_first_dim(size_t offset, size_t size) const; Tensor contiguous() const; Tensor to(DeviceType target) const;
  ...
  int32_t* data_i32(); const int32_t* data_i32() const;
 private:
